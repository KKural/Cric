"""
Django settings for indcric project.
...
ROOT_URLCONF = "indcric.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [os.path.join(BASE_DIR, 'indcric', 'templates')],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "indcric.wsgi.application"
